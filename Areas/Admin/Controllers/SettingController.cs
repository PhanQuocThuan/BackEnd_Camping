...
namespace BackEnd_Camping.Areas.Admin.Controllers
{
    ...
    public class SettingController : Controller
    {
        ...
        public SettingController(CampingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SET_ID,Name,Value,Description,DataType,IsEditable,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SET_ID,Name,Value,Description,DataType,IsEditable,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] Setting setting)
        {
